...
- Public benchmark evaluation using WISDM for reproducibility and scientific credibility.
...
The project should not be described as state-of-the-art. It is a compact, reproducible engineering and research prototype focused on lightweight models, subject-wise evaluation, TensorFlow Lite export, and future Android deployment.

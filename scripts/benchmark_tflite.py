...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--input-shape", required=True, help="Comma-separated shape, e.g. 1,128,4.")
    parser.add_argument("--runs", type=int, default=500, help="Measured inference runs.")
    parser.add_argument("--warmup", type=int, default=50, help="Warmup inference runs.")
    parser.add_argument("--out", default=None, help="Optional benchmark JSON output path.")
...
def main() -> None:
    ...
    benchmark_tflite_model(args.model, input_shape, runs=args.runs, warmup=args.warmup, out_path=args.out)
